...
public class Calculation {
    ...
    static int getRam(ArrayList<String > arr){
    ...
    static   int getCpu(ArrayList<String > arr){
   ...
   */
    ...
    static int getColor(ArrayList<String > arr){
   ...
   */
    ...
    static int getSize(ArrayList<String > arr){

        int price=0;

        for (int i = 0; i <arr.size() ; i++) {

            if (arr.get(i).contains("Mini"))
                price+=100;
